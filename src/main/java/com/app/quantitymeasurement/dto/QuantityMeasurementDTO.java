...
/**
 * UC17 Data Transfer Object for QuantityMeasurementEntity.
 * Used to transfer data between the service layer and REST controllers.
 * Includes static factory methods for entity-DTO conversion.
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
public class QuantityMeasurementDTO {
    ...
    /**
     * Convert a QuantityMeasurementEntity to a QuantityMeasurementDTO.
     */
    public static QuantityMeasurementDTO fromEntity(QuantityMeasurementEntity entity) {
        ...
        dto.setOperation(entity.getOperationType());
    ...
    /**
     * Convert this DTO back to a QuantityMeasurementEntity.
     */
    public QuantityMeasurementEntity toEntity() {
        ...
        entity.setOperationType(this.operation);
